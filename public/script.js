document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchTourDates() {
        try {
            ...
            if (dates.length === 0) {
                tourList.innerHTML = '<p class="no-dates">No upcoming tour dates. Check back soon!</p>';
                return;
            }
            ...
            dates.forEach(date => {
                ...
                dateItem.innerHTML = `
                    ...
                    <a href="${date.ticket_url}" target="_blank" class="ticket-button">Get Tickets</a>
                `;
            ...
            tourList.innerHTML = '<p class="no-dates">Could not load tour dates. Please try again later.</p>';
        }
    }
